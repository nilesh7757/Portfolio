...
const TypedText = ()=>{
  return (
    <>
    <div id="#Home" className="w-[100%]  static mx-auto overflow-hidden h-[100vh] px-2 sm:top-20 lg:top-0 ">
    <div className='absolute w-[100vw] lg:w-fit flex flex-col items-center lg:right-20 top-20 lg:mt-[5vh] md:mt-[8vh] object-cover  h-[30px]'>
      ...
      <div className="text-3xl items-center text-center w-full lg:items-start  sm:top-[330px] top-[270px]  relative lg:left-20  md:text-4xl {inter.className} font-bold flex flex-col lg:top-16  p-10 lg:gap-y-12 gap-y-4">
